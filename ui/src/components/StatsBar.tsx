...
function StatCard({ icon, label, value }: { icon: React.ReactNode; label: string; value: string }) {
	return (
		<div className="glass flex items-center gap-3 rounded-xl border border-gray-200/60 dark:border-zinc-800 bg-white/80 dark:bg-zinc-900/80 px-4 py-3 shadow-sm">
			<div className="flex items-center justify-center w-9 h-9 rounded-lg bg-indigo-500/10 dark:bg-indigo-500/20 text-indigo-500">
				{icon}
			</div>
			<div>
